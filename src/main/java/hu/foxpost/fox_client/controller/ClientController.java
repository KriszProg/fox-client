...
import hu.foxpost.fox_client.client.ClientServiceClient;
...
public class ClientController {
     ...
     * - If no match: return 404 (Client not found)
     *
     * @param id client.id
     */
    @GetMapping("/{id}")
    ...
    public List<ClientDto> searchClients(
        ...
        return clientServiceClient.searchClients(clientName, address, zipCode, city, phone, email);
    }
